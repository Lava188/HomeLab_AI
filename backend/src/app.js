...
const adminNotificationRoute = require("./routes/admin-notification.route");
const userAuthRoute = require("./routes/user-auth.route");
const collectorAuthRoute = require("./routes/collector-auth.route");
const collectorNotificationRoute = require("./routes/collector-notification.route");
...
app.use("/api/collector/notifications", collectorNotificationRoute);
