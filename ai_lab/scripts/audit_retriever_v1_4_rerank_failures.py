...
OUT_REPORT_PATH = ROOT / "ai_lab" / "reports" / "retriever_v1_4_rerank_failure_audit_report.json"
OUT_EXAMPLES_PATH = ROOT / "ai_lab" / "reports" / "retriever_v1_4_rerank_failure_audit_examples.csv"
...
def main() -> None:
    ...
    summary = {
        "total_eval_rows": report.get("rerank", {}).get("count", len(details)),
        "hit_at_1": report.get("rerank", {}).get("hit_at_1"),
        "hit_at_3": report.get("rerank", {}).get("hit_at_3"),
        "hit_at_5": report.get("rerank", {}).get("hit_at_5"),
    ...
    output = {
        "report_name": "retriever_v1_4_rerank_failure_audit_report",
        "summary": summary,
        "important_examples": examples,
        "examples_csv": "ai_lab/reports/retriever_v1_4_rerank_failure_audit_examples.csv",
