...
- nhs_anaphylaxis: approved - Approved via conservative source-specific curation template.
- nhs_blood_tests: holdout - Exact NHS blood tests duplicate of the already-registered baseline source.
- nhs_fainting_adults: approved - Approved via conservative source-specific curation template.
- nhs_fainting_adults: approved - Approved via conservative source-specific curation template.
- nhs_headaches: approved - Approved via conservative source-specific curation template.
- nhs_headaches: approved - Approved via conservative source-specific curation template.
- nhs_stomach_ache: approved - Approved via conservative source-specific curation template.
- nhs_stomach_ache: approved - Approved via conservative source-specific curation template.
- nhs_stroke_symptoms: approved - Approved via conservative source-specific curation template.
- nhs_stroke_symptoms: approved - Approved via conservative source-specific curation template.
